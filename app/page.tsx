...
export default function Home() {
  ...
  return <main style={{ "--accent": settings.primaryColor } as CSSProperties}>
    ...
    <section className="section intro" id="about"><div className="container intro-grid"><div><p className="eyebrow dark">Willkommen bei Costa&apos;s</p><h2>Ein Stück Indien im Herzen von Sittensen</h2></div><p>Traditionelle indische Kochkunst trifft auf herzliche Gastfreundschaft. Unsere Gerichte werden frisch zubereitet und auf Wunsch mild, würzig oder original indisch serviert.</p></div></section>
